...
class TaskSpecOpeninferenceServe(TaskSpecFunction):
    """TaskSpecOpeninferenceServe specifications."""
...
class TaskValidatorOpeninferenceServe(TaskValidatorFunction):
    """
    TaskValidatorOpeninferenceServe validator.
    """
